...
const StepFive = () => {
  ...
  <ol className="c31 lst-kix_list_2-0 start" start={1}>
    <li className="c25 c30 li-bullet-0">
      <span className="c0">
        The applicant named above was employed by us as ________________ from
  ...
  <ol className="c31 lst-kix_list_2-0" start={5}>
    <li className="c7 li-bullet-0">
      <span className="c0">
        ...
        accident/incident which is on your accident register or was reported to
  ...
  <ol className="c31 lst-kix_list_2-0" start={6}>
    ...
    <li className="c7 li-bullet-0">
      <span className="c0">
        Was applicant subject to FMCSR while employed and/or his job designated
        as a safety sensitive function in any DOT-regulated mode subject to the
    ...
    <tbody>
      <tr className="c16">
        <td className="c19" colSpan={1} rowSpan={1}>
          <p className="c1 c20">
            <span className="c0">
              Has this person had an alcohol test with the result of 0.04 or
      ...
      <tr className="c14">
        <td className="c19" colSpan={1} rowSpan={1}>
          <p className="c1 c20">
            <span className="c0">
              Has this person refused to submit to a post-accident, random,
              reasonable suspension, or follow-up alcohol or controlled
              substance test?
            </span>
          </p>
        </td>
      ...
      <tr className="c14">
        <td className="c19" colSpan={1} rowSpan={1}>
          <p className="c1 c20">
            <span className="c0">
              Has this person committed other violations of subpart B of Part
              382, or Part 40?
            </span>
          </p>
        </td>
      ...
      <tr className="c14">
        <td className="c19" colSpan={1} rowSpan={1}>
          <p className="c1 c20">
            <span className="c0">
              If this person has violated a DOT drug and alcohol regulation, did
              this person complete a SAP-prescribed rehabilitation program in
              your employ, including return-to-duty and follow-up tests? If Yes,
              please send documentation back with this form.
            </span>
          </p>
        </td>
        <td className="c33" colSpan={1} rowSpan={1}>
        ...
        <td className="c19" colSpan={1} rowSpan={1}>
          <p className="c1 c20">
            <span className="c0">
              ...
              referral and remained in your employ, did this driver subsequently
              have an alcohol test result of 0.04 or greater, a verified
      ...
      <tr className="c28">
        <td className="c22" colSpan={1} rowSpan={1}>
          ...
          <p className="c3">
            ...
            <span className="c2">: ___________________________________</span>
          </p>
          <p className="c3">
            <span className="c2">
          ...
          <p className="c24">
            ...
            <span className="c0">
              &nbsp;to contact my previous employer(s) in order to verify my
              Employment History, Safety Performance History and Drug &amp;
              Alcohol History and to obtain the following information. I release
              my prospective and previous employer(s) and its employee(s) from
              any and all liabilities which may result from furnishing such
              information.
            </span>
          </p>
          <p className="c1 c6">
