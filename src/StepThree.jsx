          ...
          <div className="sm:col-span-3">
            ...
            <div className="mt-2">
              <input
                ...
                onChange={(e) =>
                  handleEmploymentChange(index, "employerName", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="sm:col-span-3">
            ...
            <div className="mt-2">
              <input
                ...
                onChange={(e) =>
                  handleEmploymentChange(index, "positionHeld", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="sm:col-span-3">
            ...
            <div className="mt-2">
              <input
                ...
                onChange={(e) =>
                  handleEmploymentChange(index, "reasonForLeaving", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="sm:col-span-3 w-full mt-6">
            ...
            <div className="mt-2">
              <div className="flex items-center space-x-4">
                ...
                />
                <label htmlFor={`question-one-true-${index}`} className="text-gray-900">
                  True
                </label>
                <input
                  type="radio"
                  ...
                  className="text-indigo-600 focus:ring-indigo-500"
                />
                <label htmlFor={`question-one-false-${index}`} className="text-gray-900">
                  False
                </label>
              </div>
            </div>
            ...
            <div className="mt-2">
              <div className="flex items-center space-x-4">
                <input
                  ...
                  className="text-indigo-600 focus:ring-indigo-500"
                />
                <label htmlFor={`question-two-true-${index}`} className="text-gray-900">
                  True
                </label>
                <input
                  type="radio"
                  ...
                  className="text-indigo-600 focus:ring-indigo-500"
                />
                <label htmlFor={`question-two-false-${index}`} className="text-gray-900">
                  False
                </label>
              </div>
            </div>
